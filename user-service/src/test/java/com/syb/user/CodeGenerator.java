...
//        config.setBaseColumnList(true);
        ...
        //数据库连接地址
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/1708d?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        //驱动类 名称
        dataSourceConfig.setDriverName("com.mysql.jdbc.Driver");
        //用户名
        dataSourceConfig.setUsername("root");
        //密码
        dataSourceConfig.setPassword("songyubing0925");
